...
public class MissingPredictor extends BasePredictor {
    ...
    public MissingPredictor(AnalysisFacade analysisFacade) {
    ...
    public int[][] predict() {
        ...
        List<Integer> missingFront = analysisFacade.getMissingDueFrontNumbers(15);
        // 获取遗漏到期的后区号码（取前6个作为候选池）
        List<Integer> missingBack = analysisFacade.getMissingDueBackNumbers(6);
